...
ALTER TABLE "clinic_patients" DROP CONSTRAINT IF EXISTS "clinic_patients_responsible_doctor_id_doctors_id_fk";
--> statement-breakpoint
...
ALTER TABLE "clinic_patients" DROP COLUMN IF EXISTS "responsible_doctor_id";