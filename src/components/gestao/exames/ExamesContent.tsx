...
import type { ClinicExamListRow } from "@/db/queries/exams";
...
const EXAM_STATUSES = ["scheduled", "in_progress", "finished", "cancelled"] as const;
...
interface ExamesContentProps {
    rows: ClinicExamListRow[];
    doctors: { id: string; name: string | null }[];
    showDoctorFilter: boolean;
}

export function ExamesContent({ rows, doctors, showDoctorFilter }: ExamesContentProps) {
                                ...
                                <TableRow key={r.id}>
                                    ...
                                    <TableCell>
                                        <Badge variant="outline" className="font-normal">
                                            {r.location === "in_clinic" ? "Na clínica" : "Externo"}
                                        </Badge>
                                    </TableCell>
                                    <TableCell>
