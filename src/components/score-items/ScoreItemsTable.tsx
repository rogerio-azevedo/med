...
import { DeleteScoreItemDialog } from "./DeleteScoreItemDialog";
import { EditScoreItemDialog } from "./EditScoreItemDialog";
...
export function ScoreItemsTable({ scoreItems }: { scoreItems: ScoreItem[] }) {
