...
import { deleteSpecialtyAction } from "@/app/actions/specialties";
...
export function DeleteSpecialtyDialog({ specialty, isOpen, onOpenChange }: DeleteSpecialtyDialogProps) {
    ...
    async function onDelete() {
        ...
        try {
            ...
            if (result.success) {
                ...
                toast.error(result.error || "Erro ao remover especialidade");
            }
        } catch (error) {
            ...
            <DialogContent className="sm:max-w-[400px] p-0 overflow-hidden border-none shadow-2xl bg-white">
                <div className="bg-destructive/10 p-6 pb-4 border-b border-destructive/20">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <DialogTitle className="text-xl font-bold tracking-tight text-destructive">Remover Especialidade</DialogTitle>
                ...
                <div className="p-6">
                    <p className="text-sm text-muted-foreground leading-relaxed">
                        Você tem certeza que deseja remover a especialidade <span className="font-bold text-foreground">"{specialty.name}"</span>?
                        Isso pode afetar médicos que possuem esta especialidade vinculada.
                    </p>
                </div>
